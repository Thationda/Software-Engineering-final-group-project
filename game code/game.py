...
class Game:
    ...
    is_paused: bool = True
    display_caption_prefix: str = "Lost into the Woods"
    ...
    def play_function(self,difficulty: List, font: 'pygame.font.Font', test: bool = False) -> None:
        ...
        f_esc = font.render('Game Ended', True, (194, 178, 128))
    ...
    def prep_play_menu(self):
        ...
        submenu_theme.background_color=(23, 176, 110)
...
,                       onchange=self.change_rows,
    ...
    def prep_menu(self):
        ...
        surface = create_example_window('Lost in to the woods', (WINDOW_WIDTH,WINDOW_HEIGHT))
        ...
        f = pygame_menu.font.FONT_COMIC_NEUE
        main_theme = pygame_menu.themes.THEME_DARK.copy()
        main_theme.background_color=(23, 176, 110)
